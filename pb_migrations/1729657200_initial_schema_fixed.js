...
migrate((db) => {
  // Get existing users auth collection and add custom fields
  const usersCollection = $app.dao().findCollectionByNameOrId("_pb_users_auth_");
  ...
  $app.dao().saveCollection(clientsCollection);
  ...
  $app.dao().saveCollection(buildingsCollection);
  ...
  const projectsCollection = new Collection({
    ...
    schema: [
      ...
      },
      {
        ...
        required: false,
        options: {
          collectionId: buildingsCollection.id,
          cascadeDelete: false,
          maxSelect: 999,
        },
      },
  ...
  $app.dao().saveCollection(auditsCollection);
  ...
  $app.dao().saveCollection(energyDataCollection);
    ...
    schema: [
      {
        ...
        required: false,
        options: {
          collectionId: auditsCollection.id,
          cascadeDelete: true,
          maxSelect: 1,
        },
      },
  ...
  $app.dao().saveCollection(recommendationsCollection);
  ...
  $app.dao().saveCollection(equipmentCollection);
  ...
  $app.dao().saveCollection(tasksCollection);
  ...
  $app.dao().saveCollection(customViewsCollection);

  return true;
}, (db) => {
  // Rollback - remove custom fields from users and delete other collections
  const usersCollection = $app.dao().findCollectionByNameOrId("_pb_users_auth_");

  // Remove custom fields
  usersCollection.schema.removeField("name");
