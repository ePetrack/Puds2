...
<svelte:head>
	<title>Edit Meter {data.meterNumber} - Energy Management Platform</title>
</svelte:head>
...
<div class="mx-auto max-w-3xl space-y-6">
	<div>
		...
		<h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Meter {data.meterNumber}</h1>
	</div>
